...
- Cold-clone target passed against final HEAD `25f9d36`: `tools/verify/cold_clone.sh verify-E0-T10` with scrubbed environment and no warm server/cache residue.
