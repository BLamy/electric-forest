...
**37 / 103 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E3-T02a** — "Authenticated app shell: session-backed whoami, SPA routing, and frozen DOM stream-triple contract" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E3-T02a** clears the current gate.

## Unlocks when E3-T02a verifies

1. **E3-T02b** — "Browser evidence hardening: full-wire credential scanner and atomic Replay publication"
...
- [?] `302` [E3-T02a](epic-3-the-canopy/E3-T02a-app-shell-contract/readme.md) — "Authenticated app shell: session-backed whoami, SPA routing, and frozen DOM stream-triple contract" *(deps: E2)*
