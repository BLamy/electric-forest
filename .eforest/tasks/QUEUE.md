...
**71 / 104 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E5-T13** — "Capstone: issue-to-merge — file, branch, PR, review, merge; the issue flips to done via the merge, watched live, replayed offset-by-offset, zero databases" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E5-T13** clears the current gate.

## Unlocks when E5-T13 verifies

1. **E5-T14** — "Capstone: the meadow as a polished code host — supplied dark product shell, Docstream markdown, Pierre diffs, and Trees file browsing"
