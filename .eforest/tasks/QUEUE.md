...
**70 / 104 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E5-T12** — "Negotiation replay harness: multi-stream session dumps replayed to one composite digest, promoted to make verify-E5-negotiation" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E5-T12** clears the current gate.

## Unlocks when E5-T12 verifies

1. **E5-T13** — "Capstone: issue-to-merge — file, branch, PR, review, merge; the issue flips to done via the merge, watched live, replayed offset-by-offset, zero databases"
