...
**77 / 104 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E6-T05** — "Task folders on streams: bidirectional projection without echo, drift, or side-channel status writes" *(awaiting independent critic)*
...
1. **E6-T06** — "Live task board: queue, project state, task folders, findings, and evidence in the web app"
