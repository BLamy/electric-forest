...
No new task may start until **E3-T03** clears the current gate.

## Unlocks when E3-T03 verifies

1. **E3-T04** — "Live repository and organization browse from the registry event stream"
1. **E3-T05** — "Repository home: metadata, native branch forks, and live project status"
