...
**32 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E2-T09** — "Writer-scoped application fencing above global Stream-Seq ordering" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E2-T09** clears the current gate.

## Unlocks when E2-T09 verifies

1. **E2-T10** — "Platform authorization conformance matrix over official-stream-backed operations"
