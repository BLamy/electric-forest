...
**18 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Next up (deps satisfied, in priority order)

1. **E1-T06** — "Convergence harness: ef materialize plus a two-client exact-diff verify target"
1. **E1-T07** — "Snapshots: offset-anchored compaction with bootstrap reads and 410 Gone retention semantics"
