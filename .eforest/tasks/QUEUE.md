...
**34 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E2-T11** — "Platform rate limits and tenant isolation before official-stream access" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E2-T11** clears the current gate.

## Unlocks when E2-T11 verifies

1. **E2-T12** — "Capstone: the locked gate on Auth0, the platform gateway, and Electric Durable Streams"
