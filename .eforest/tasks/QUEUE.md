...
**55 / 103 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E4-T09** — "Two-machine convergence harness: seeded scripted edits, partition hooks, exact-diff assertions, promoted to make verify-E4-sync" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E4-T09** clears the current gate.

## Unlocks when E4-T09 verifies

1. **E4-T10** — "Offline catch-up: a stopped watcher reconciles both directions deterministically before going live"
