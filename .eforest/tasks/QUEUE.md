...
- [ ] `506` [E5-T06](epic-5-the-meadow/E5-T06-pr-merge-execution/readme.md) — "Merge through the PR door: the merge event drives the log-aware merge onto the target branch stream, conflicts surface as PR events" *(deps: E5-T02)*
