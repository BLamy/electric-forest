...
**37 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E3-T02** — "Web app shell: authenticated React app served by the platform, browser-verify harness wired, DOM offset/digest exposure contract frozen" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E3-T02** clears the current gate.

## Unlocks when E3-T02 verifies

1. **E3-T03** — "useStreamReducer: read and follow official-stream-backed application events in the browser"
