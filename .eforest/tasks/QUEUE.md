...
**16 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Next up (deps satisfied, in priority order)

1. **E1-T04** — Stale-write fencing — writes and patches declare their base; stale writes refused with the log untouched
1. **E1-T05** — "watch(): chokidar-compatible live events from a tailing client, resumable from a saved offset"
