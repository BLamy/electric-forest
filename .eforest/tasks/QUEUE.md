...
**22 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E1-T10** — Three-way merge on patches with conflicts surfaced as events *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

No new task may start until **E1-T10** clears the current gate.

## Unlocks when E1-T10 verifies

1. **E1-T11** — "Capstone: the first repository on Electric Durable Streams"
