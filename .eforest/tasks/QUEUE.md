...
**58 / 103 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E4-T12** — "Capstone: two-machines-one-branch — two watched working directories converge live, survive a partition with a surfaced conflict, and digest-match replay(branch), cold start via make verify-E4-*" *(builder working)*

## Next up (deps satisfied, in priority order)

No new task may start until **E4-T12** clears the current gate.

## Unlocks when E4-T12 verifies
