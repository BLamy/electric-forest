...
**30 / 101 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E2-T07** — "Platform authorization: per-repository read, follow, and dispatch decisions before official-stream access" *(awaiting independent critic)*

## Next up (deps satisfied, in priority order)

1. **E2-T08** — "The __registry__ promoted to a real project index: a derived stream rebuilt by replay — losing the index loses nothing"

## Unlocks when E2-T07 verifies

1. **E2-T09** — "Writer-scoped application fencing above global Stream-Seq ordering"
