...
**42 / 103 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E3-T06** — "Live StreamFS tree browser with deterministic digest" *(awaiting independent critic)*
...
1. **E3-T07** — "Live patch-aware file viewer over canonical StreamFS events"
