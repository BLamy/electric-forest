...
verify-E1-T09: _v-fmt _v-lint _v-typecheck _v-test _v-build _v-meta verify-list verify-E1-T06 verify-E1-T08
	@CI=true pnpm --silent exec vitest run packages/streamfs/test/merge-ff.test.ts
	@node tools/verify/merge_ff.mjs
	@node tools/verify/merge_race.mjs
	@node tools/verify/merge_replay_attacks.mjs
	@bash tools/verify/merge_sensitivity.sh
